...
import {Ecommerce,Orders,Calendar,Employees,Stacked,Pyramid,Customers,Kanban,Area,
  Pie,Bar,Financial,ColorPicker,Line,ColorMapping,Editor} from "./pages";
      ...
      <BrowserRouter>
        <div className='flex relative dark:bg-main-dark-bg'>
          <div className='fixed right-4 bottom-4' style={{zIndex:'1000'}}>
            ...
            <button type='button' className='text text-3xl p-3 hover:drop-shadow-xl hover:bg-light-gray text-white'
